...
*/
TGL_FEATURE_STRICT_OOM_CHECKS :: 0
...
*/
TGL_FEATURE_FISR         :: 0
TGL_FEATURE_ARRAYS       :: 1
TGL_FEATURE_DISPLAYLISTS :: 1
TGL_FEATURE_LIT_TEXTURES :: 1

/* Enable the patternized "discard"-ing of pixels.*/
TGL_FEATURE_POLYGON_STIPPLE :: 0

/* Enable the use of GL_SELECT and GL_FEEDBACK*/
TGL_FEATURE_ALT_RENDERMODES :: 0
...
*/
TGL_FEATURE_GL_POLYGON        :: 0
TGL_FEATURE_BLEND             :: 1
TGL_FEATURE_BLEND_DRAW_PIXELS :: 0

/* The width of textures as a power of 2. The default is 8, or 256x256
* textures
*/
TGL_FEATURE_TEXTURE_POW2 :: 8
TGL_FEATURE_TEXTURE_DIM  :: (1<<TGL_FEATURE_TEXTURE_POW2)

/* A stipple pattern is 128 bytes in size. */
TGL_POLYGON_STIPPLE_BYTES :: 128

/* A stipple pattern is 2^5 (32) bits wide. */
TGL_POLYGON_STIPPLE_POW2_WIDTH :: 5
TGL_POLYGON_STIPPLE_MASK_X     :: 31
TGL_POLYGON_STIPPLE_MASK_Y     :: 31

/* Use lookup tables for calculating specular light. */
TGL_FEATURE_SPECULAR_BUFFERS :: 0

/* Prevent ZB_copyFrameBuffer from copying certain colors. */
TGL_FEATURE_NO_COPY_COLOR :: 0

/* Don't draw (texture mapped) pixels whose color is the NO_DRAW_COLOR */
TGL_FEATURE_NO_DRAW_COLOR :: 0

/* Regardless of the current clear color, always clear using the NO_COPY_COLOR
*/
TGL_FEATURE_FORCE_CLEAR_NO_COPY_COLOR :: 0
TGL_NO_COPY_COLOR                     :: 0xff00ff
TGL_NO_DRAW_COLOR                     :: 0xff00ff

/* solid debug pink.*/
TGL_COLOR_MASK :: 0x00ffffff

/* mask to check for while drawing/copying.*/
TGL_FEATURE_MULTITHREADED_DRAWPIXELS       :: 1
TGL_FEATURE_MULTITHREADED_COPY_TEXIMAGE_2D :: 1
TGL_FEATURE_MULTITHREADED_ZB_COPYBUFFER    :: 0

/*
* Dirty rectangle optimization - track modified screen regions and only copy
* changed portions to the destination framebuffer.
*/
TGL_FEATURE_DIRTY_RECTANGLE :: 1
...
*/
TGL_OPTIMIZATION_HINT_BRANCH_COST :: 2
TGL_FEATURE_16_BITS               :: 0
TGL_FEATURE_32_BITS               :: 1
TGL_FEATURE_RENDER_BITS           :: 32

/* The fraction bits in the fixed point values used for S and T in
* interpolatiion.
*/
ZB_POINT_S_FRAC_BITS :: 10
ZB_POINT_T_FRAC_BITS :: (ZB_POINT_S_FRAC_BITS+TGL_FEATURE_TEXTURE_POW2)

/* Test the compatibility of the target platform at glInit() time. */
TGL_FEATURE_TINYGL_RUNTIME_COMPAT_TEST :: 1
TINYGL_VERSION                         :: 1.0
